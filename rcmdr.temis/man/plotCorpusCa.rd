...
\arguments{
  ...
  \item{pch}{Vector of length 4 giving the type of points to be used for row active and supplementary, column active and supplementary points.}
...
\author{Oleg Nenadic (adapted from \code{\link[ca]{plot.ca}} by Milan Bouchet-Valat)}
\references{
...
\seealso{\code{\link{runCorpusCa}}, \code{\link{corpusCaDlg}}, \code{\link{summary.ca}}, \code{link[ca]{print.ca}}, \code{link[ca]{plot3d.ca}}}
