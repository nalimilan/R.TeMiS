...
\details{This dialog wraps the \code{\link{corpusCa}} function: see its help page for details.
...
\seealso{\code{\link{corpusCa}}, \code{\link{ca}}, \code{\link{meta}}, \code{\link{removeSparseTerms}},
