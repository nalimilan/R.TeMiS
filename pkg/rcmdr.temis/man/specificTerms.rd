...
\usage{
specificTerms(variable, dtm, p = 0.1, n.max = 25, sparsity = 0.95, min.occ = 2)
}
\arguments{
  \item{variable}{a vector whose length is the number of rows of \code{dtm}.}
...
\value{A list of matrices, one for each level of the variable, with five columns:
...
\seealso{\code{\link{DocumentTermMatrix}}, \code{\link{removeSparseTerms}}}
